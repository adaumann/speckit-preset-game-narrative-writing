...
# Examples: [sugarcube], [generic, sugarcube], [ink]
...
illustrations_enabled: [yes / no]
# If yes, populate the following:
default_illustration_style: [style_key]
default_illustration_color_range: [full / 2color / greyscale]
default_illustration_aspect: [landscape / portrait / square]
default_background_type: [environment / interior / exterior / abstract]
illustration_dir: assets/illustrations/
---
...
## XI. Illustration Configuration
<!-- Configure illustration and background image settings for this project. -->

| Field | Value | Description |
|---|---|---|
| Illustrations | [yes / no] | Enable illustration prompt generation |
| Default Style | [STYLE_KEY] | Visual style for all illustrations (see speckit.illustrate Style Catalogue) |
| Default Color Range | [full / 2color / greyscale] | Color palette for generated prompts |
| Default Aspect Ratio | [landscape / portrait / square] | Output aspect ratio for prompts |
| Default Background Type | [environment / interior / exterior / abstract] | Environment type for background prompts |
| Image Directory | assets/illustrations/ | Folder for generated PNG files |

Illustration prompts are generated by `speckit.illustrate` and `speckit.background`. PNG files must match node IDs (`<NODE_ID>.png`) and are embedded at the start of each node during compilation.
