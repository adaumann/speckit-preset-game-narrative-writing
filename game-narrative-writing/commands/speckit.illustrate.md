...
handoffs:
  - label: Compile to Playable Output
    ...
    prompt: Compile the game — illustration references are ready for embedding
    send: false
...
|---|---|
| Node title | `specs/[FEATURE_DIR]/outlines/<NODE_ID>-outline.md` or `specs/[FEATURE_DIR]/draft/<NODE_ID>*.md` |
